...
Bind loaded DataFrames to PuppyGraph node/edge types via schema mapped fields
and expose graph ids, attributes, and relationship keys. Also materialize a
MappedGraph from user-provided CSV↔graph mappings over result-shaped CSV/TSV
files.
